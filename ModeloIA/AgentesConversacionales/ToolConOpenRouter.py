...
# Agente con OpenRouter y tools personalizadas
dice_agent = Agent(
    name="dice_agent",
    model=LiteLlm(
    ...
    instruction="Lanzas dados y verificas primos. Usa las tools disponibles.",
    description="Agente con GPT-4o-mini y tools",
